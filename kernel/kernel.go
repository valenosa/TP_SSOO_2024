...
func dispatch(pcb proceso.PCB, configJson config.Kernel) (proceso.PCB, string) {
...
// log obligatorio (4/6)
func logFinDeProceso(pcb proceso.PCB, motivoDeFinalizacion string) {
